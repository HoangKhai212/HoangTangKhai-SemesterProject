...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.ExerciseViewHolder>{
...
//            holder.txtId.setText(e.getId());
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(context, RemoveUpdateExActivity.class);
